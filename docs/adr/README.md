...
Short ADRs: **Context · Decision · Consequences**. Numbered `ADR-NNN-slug.md`. Any dependency outside the approved stack (TypeScript, commander, zod, vitest, tsup) requires one.
